...
### 🧵 String Functions
- `k_strlen`, `k_strdup`, `k_strcmp`, `k_strncmp`,`k_strcpy`
- `k_strncpy`, `k_strcat`, `k_strncat`, `k_strlcpy`, `k_strlcat`
- `k_strchr`, `k_strrchr`, `k_strstr`, `k_strnstr`
- `k_strjoin`, `k_strtrim`, `k_split`, `k_substr`
 
Functional mapping utilities:
- `k_strmapi`, `k_striteri`
...
### 🧱 Memory Utilities
- `k_bzero`, `k_memset`, `k_memcpy`, `k_memmove`,
- `k_memcmp`, `k_memchr`, `k_calloc`
...
- `k_lstlast`, `k_lstsize`, `k_lstdelone`
- `k_lstclear`, `k_lstiter`, `k_lstmap`

### 🖨 Output Helpers
- `k_putchar`, `k_putchar_fd`, `k_putendl`, `k_putendl_fd`
- `k_putnbr`, `k_putnbr_fd`, `k_putstr`, `k_putstr_fd`
